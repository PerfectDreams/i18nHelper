...
/**
 * ListI18nKey is used to store a translation [key], used for type safe calls in [net.perfectdreams.i18nhelper.core.I18nContext].
 *
 ...
 */
@Serializable
class ListI18nKey(override val key: String) : I18nKey()